...
* Exploratory Data Analysis (EDA) on raw SCADA dataset.
* Identify anomalies, missing values and propose initial data cleaning methods.
...
* Completed EDA analysis scenario for SCADA data.
* Identified important features and noise to be processed.
