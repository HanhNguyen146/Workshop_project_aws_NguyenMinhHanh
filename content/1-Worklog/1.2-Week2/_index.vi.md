...
* Phân tích khám phá dữ liệu (EDA) trên tập dữ liệu SCADA thô.
* Xác định các bất thường, giá trị thiếu và lên phương án làm sạch dữ liệu ban đầu.
...
* Hoàn thành kịch bản phân tích EDA cho dữ liệu SCADA.
* Xác định được các đặc trưng quan trọng và các nhiễu cần xử lý.
