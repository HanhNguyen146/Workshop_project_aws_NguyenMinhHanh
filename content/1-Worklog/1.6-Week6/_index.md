...
| --- | --------- | ------------ | --------------- | -------------- |
| Mon | - Extend `validate_data()` module to check data distribution (Data Drift). | 06/07/2026 | 06/07/2026 | |
| Tue | - Add exception checking rules: physical min/max limits of each sensor. | 07/07/2026 | 07/07/2026 | |
| Wed | - Integrate Exception handling and clear Logging in `data_validation.py`. | 08/07/2026 | 08/07/2026 | |
| Thu | - Generate testing reports in JSON/Text format. | 09/07/2026 | 09/07/2026 | |
