...
* Write technical documentation, prepare final report.
* Hand over preprocessing and validation pipeline to the project team.
...
* Successfully handed over the entire data cleaning and validation module.
* Successfully contributed to the closed-loop SCADA Fault Prediction system.
