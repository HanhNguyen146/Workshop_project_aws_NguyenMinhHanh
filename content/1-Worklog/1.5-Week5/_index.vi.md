...
| --- | --------- | ------------ | --------------- | -------------- |
| 2 | - Nghiên cứu phương pháp tạo lag features cho dữ liệu chuỗi thời gian SCADA. | 29/06/2026 | 01/07/2026 |  |
| 3 | - Bổ sung hàm tạo đặc trưng `rolling_mean`, `rolling_std` vào `src/preprocessing.py`. | 30/06/2026 | 01/07/2026 |  |
| 4 | - Xử lý đặc trưng góc (ví dụ: góc quay tuabin) bằng phép biến đổi lượng giác (sin/cos). | 01/07/2026 | 02/07/2026 |  |
| 5 | - Thực hiện Scaling/Normalization dữ liệu bằng `StandardScaler`. | 02/07/2026 | 03/07/2026 |  |
